      ...
      <div className="container">
        ...
        <div className="row mx-2 mt-1 d-flex justify-content-between align-items-center">
          ...
          <div className="col-4 mx-2 my-4 pt-4 box">
            <div className="d-flex justify-content-between mb-3">
              <img src="https://img.icons8.com/color/32/000000/mastercard-logo.png" alt="logo"/>
              <span>1234</span>
            </div>
            <div className="d-flex justify-content-center align-items-center">
          ...
          <div className="col mx-2 p-3 box3">
            <div className="d-flex justify-content-between align-items-center">
              <div className="logo-bg py-4 px-2 rounded">
                <img src="https://img.icons8.com/fluent-systems-filled/30/000000/select-cell.png" alt="logo"/>
              </div>
              <div className="ml-2">
                <strong>Multiple Pay</strong>
                <p className="space">Send payments to many people at a go.!</p>
              </div>
              <button type="button" className="btn rounded-pill button align-items-start">Send</button>
            </div>
          </div>
        </div>
        ...
        <div className="d-flex flex-row flex-nowrap">
          ...
          <div className="col-4 text-center">
            <img src="data:image/png;base64," />
            <br />
            <strong style={{ fontSize: "13px" }}>Bakery Staff</strong>
            <br />
            <p className=""><small> 11 people</small></p>
